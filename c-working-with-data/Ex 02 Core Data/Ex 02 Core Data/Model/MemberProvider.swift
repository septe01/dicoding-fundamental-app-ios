...
//  Ex 02 Core Data
//
//  Created by septe habudin on 18/10/22.
//

import CoreData
import UIKit

//menyediakan Persisten Container
class MemberProvider {

  lazy var persistentContainer: NSPersistentContainer = {

      // MARK: name database
    let container = NSPersistentContainer(name: "Ex_02_Core_Data")
...
//Pembuatan persisten container ini tidak kita taruh di bagian AppDelegate ya. Fungsinya agar kita lebih mudah untuk mengelolanya
